      ...
      <div className="max-w-4xl mx-auto bg-white shadow-2xl rounded-3xl border border-gray-100 overflow-hidden">
        ...
        <div className="p-8">
              ...
              <div style={{background: 'linear-gradient(to bottom, #FAF3E0, white)'}} className="p-6">
                <div className="relative mb-6 group">
                  <div className="border-2 border-dashed border-[#B0B0B0] rounded-xl p-4 text-center transition-all hover:border-[#1E3A8A] bg-white">
                    ...
                    <p className="text-xs text-[#B0B0B0] mt-1">支持多張圖片上傳</p>
                  </div>
                </div>
              ...
              <div style={{background: 'linear-gradient(to bottom, #FAF3E0, white)'}} className="p-6">
                <div className="relative mb-6 group">
                  <div className="border-2 border-dashed border-[#B0B0B0] rounded-xl p-4 text-center transition-all hover:border-[#1E3A8A] bg-white">
                    ...
                    <p className="text-xs text-[#B0B0B0] mt-1">支持多部影片上傳</p>
                  </div>
                </div>
          ...
          <button
            ...
            className="w-full mt-10 relative overflow-hidden group text-white py-4 px-6 rounded-xl transition-all duration-500 shadow-lg hover:shadow-2xl flex items-center justify-center font-medium text-lg"
