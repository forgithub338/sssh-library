...
export default function EditProject() {
    ...
    const fetchProject = async () => {
      try {
        ...
        if (data.project) {
          ...
          // Get the subject from section
          const subjectFromSection = project.section.split("-")[0] || "";
          ...
          setFormData({
            ...
            subject: subjectFromSection,
            interest: project.section.split("-")[1] || "",
            images: newImg, // 顯示現有的圖片
            videos: newVideo, // 顯示現有的影片
            pdfs: newPdf, // 顯示現有的PDF
          });
          
          // 設置選定的學科以觸發興趣選項的更新
          setSelectedSubject(subjectFromSection);
        }
      } catch (error) {
        console.error("獲取項目數據時出錯:", error);
      } finally {
        setLoading(false);
      }
    };
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setErrors({ submit: error.message || "更新時發生錯誤，請稍後再試" });
    } finally {
      setIsSubmitting(false);
    }
  };
            ...
            <div className="max-w-3xl mx-auto px-4 sm:px-6 md:px-8">
              ...
              <div className="bg-white rounded-xl shadow-md overflow-hidden">
                ...
                <div style={{background: 'linear-gradient(to right, #1E3A8A, #2D4A9A)'}} className="p-6 text-white">
                  <h1 className="text-2xl font-bold text-center">編輯學習成果</h1>
                  <div className="h-1 w-24 bg-white/50 mt-2 mx-auto rounded-full"></div>
                  <p className="text-white text-center mt-2">更新您的學習旅程和成就</p>
                </div>
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-4 transition-all hover:shadow-md">
                      ...
                      >
                        ...
                        <p className="mt-2 text-sm text-gray-500">點擊上傳新圖片</p>
                        ...
                        <div className="mt-3 grid grid-cols-2 sm:grid-cols-3 gap-3">
                          {formData.images.map((file, index) => (
                            <div key={index} className="relative group">
                              <img 
                                src={file instanceof Blob ? URL.createObjectURL(file) : file.url || file.path} 
                                alt={file.name}
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-4 transition-all hover:shadow-md">
                      ...
                      >
                        ...
                        <p className="mt-2 text-sm text-gray-500">點擊上傳新影片</p>
                    ...
                    <div className="bg-white border border-gray-200 rounded-xl p-4 transition-all hover:shadow-md">
                      ...
                      >
                        ...
                        <p className="mt-2 text-sm text-gray-500">點擊上傳新PDF文件</p>
