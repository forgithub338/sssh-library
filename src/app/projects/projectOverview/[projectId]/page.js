                    ...
                    <div className="pt-4 border-t border-gray-200">
                      <div className="flex flex-col sm:flex-row gap-3">
                        ...
                        <a 
                          ...
                          className="px-4 py-2 bg-gray-100 text-[#333333] rounded-lg hover:bg-gray-200 transition-colors inline-flex items-center justify-center text-sm md:text-base"
                        >
